...
class ClusterUpdate(_messages.Message):
  ...
  desiredMainAuthorizedNetworksConfig = _messages.MessageField('MainAuthorizedNetworksConfig', 11)
...
class ReleaseChannel(_messages.Message):
  ...
  channel, Google maintains both the main version and the node version. Node
  auto-upgrade defaults to true and cannot be disabled. Updates to version
  related fields (e.g. current_main_version) return an error.
